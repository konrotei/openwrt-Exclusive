...
sed -i '/kmod-usb-hid/d; /kmod-usb-audio/d; /kmod-usb-net/d; /kmod-usb-net-asix/d; /kmod-usb-net-asix-ax88179/d; /kmod-usb-net-rtl8150/d; /kmod-usb-net-rtl8152-vendor/d' ./target/linux/x86/Makefile
